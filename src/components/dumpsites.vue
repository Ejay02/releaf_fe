  ...
  <div class="container mx-auto p-4">
    ...
    <div v-else>
      ...
      >
        ...
        <button
          @click="openAddModal()"
          class="w-full sm:w-auto bg-blue-500 text-white py-2 px-4 rounded hover:bg-blue-600 mt-2 sm:mt-0"
        >
          Add New Dumpsite
        </button>
      </div>
        ...
        >
          ...
          <tbody>
            ...
            >
              ...
              <td class="py-2 px-4 sm:table-cell" data-label="Status">
                <span
              ...
              <td class="py-2 px-4 sm:table-cell" data-label="Capacity">
                {{
                  new Date(dumpsite?.createdAt).toLocaleDateString("en-GB", {
                    day: "2-digit",
                    month: "short",
                    year: "numeric",
                  })
              ...
              <td class="py-2 px-4 flex justify-end space-x-2">
                <div @click="openEditModal(dumpsite)" class="cursor-pointer">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
                    viewBox="0 0 24 24"
...
const handleSearch = () => {
  ...
  dumpsites.value = dumpsites.value.filter((dumpsite) =>
    Object.values(dumpsite).some((value) =>
